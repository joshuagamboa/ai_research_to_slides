        ...
        <div class="flex justify-between items-center mb-6">
          ...
          <div class="flex space-x-3">
            <button 
              ...
              class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition-all duration-200 ease-in-out"
              :disabled="isLoading"
            >
              Generate Outline
            </button>
...
const generateOutlineInNewWindow = async () => {
  if (isLoading.value) return // Prevent generating outline while loading
  await generateOutline(true) // true means open in new window
}
